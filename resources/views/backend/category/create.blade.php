                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('category.store') }}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="inputText3" type="text" class="form-control" name="name" placeholder="Category Name"   @error('name') is-invalid @enderror>
                                                @error('name')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="inputText4" type="text" placeholder="Category Order" class="form-control" name="order" @error('order') is-invalid @enderror>
