                    ...
                    <div class="card-body">
                        <form action="{{ route('category.update', $category->id) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input id="inputText3" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $category->name) }}">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input id="inputText4" type="number" class="form-control @error('order') is-invalid @enderror" name="order" value="{{ old('order', $category->order ?? 0) }}">
                                @error('order')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
