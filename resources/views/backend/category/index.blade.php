                             ...
                             <div class="row">
                                 <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                     <div class="page-header">
                                         <h2 class="pageheader-title">Category Tables </h2>
                          ...
                          <!-- ============================================================== -->
                           <div class="col-12">
                               <div class="card table-card">
                                   ...
                                   <div class="row">
                                       <div class="col-6">
                                             <h5 class="card-header"><i class="fas fa-clipboard-list" style="margin-right:8px;"></i><span>Category list</span></h5>
                                       </div>
                                       <div class="col-6 text-right">
                                           <a href="{{ route('category.create')}}" class="btn btn-primary float-right mt-2 mr-2"><i class="fas fa-cart-plus" style="margin-right:8px"></i>Add Category</a>
                                       </div>
                                   </div>
