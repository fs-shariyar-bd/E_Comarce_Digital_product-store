...
<li class="nav-item">
                                <a class="nav-link active dashboard-link" href="{{ route('dashboard') }}"><i class="fa fa-fw fa-user-circle"></i>Dashboard</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('category.index') }}"><i class="fa fa-fw fa-tags"></i>Category Management</a>
                            </li>
